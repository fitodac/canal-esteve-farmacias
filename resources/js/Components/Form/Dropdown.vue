...
.form-dropdown{
	@apply bg-color-form border-color-form w-full mt-2 
						leading-none rounded-lg focus:border-primary-500;
	box-shadow: 0 0 0 100px var(--color-form) inset;
}

.dropdown-trigger{
	@apply w-full px-4 py-3 flex justify-between items-center relative cursor-pointer;
}

.dropdown-list{
	@apply bg-color-form w-full pt-1.5 block -mt-1 absolute rounded-b-lg z-50;
}
</style>