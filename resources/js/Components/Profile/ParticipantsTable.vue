...
let search_participants = ref(props.search_participants);
...
watch(search_participants, value => {
    Inertia.get('/mi-cuenta', { search_participants: value }, {
        preserveState: true,
        replace: true
    });
});
...
<div class="table">
	...
	<div class="table-tob-bar">
        ...
        <div class="table-search">
            <input v-model="search_participants" type="search" placeholder="Buscar..."/>
        </div>
	</div>
	...
	<div class="mt-6">
		<div class="table-header">
			<div class="table-header--li">Email auxiliar</div>
			<div class="table-header--li">Puntos</div>
			<div class="table-header--li">Razón de obtención de puntos</div>
		</div>
		...
		<div class="table-body" v-if="props.list">
			<div
				...
				<div class="table-body--li">
					<div class="table-body--li-indicator">Email auxiliar</div>
                    <div>{{ li.user.email }}</div>
				</div>
				<div class="table-body--li">
					<div class="table-body--li-indicator">Puntos</div>
                    <div>{{ li.earned_points }}</div>
				</div>
				<div class="table-body--li">
					<div class="table-body--li-indicator">Razón</div>
                    <div>{{ li.challenge.title }}</div>
				</div>
			</div>
		</div>
