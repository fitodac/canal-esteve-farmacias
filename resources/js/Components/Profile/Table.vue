...
let selected = ref(props.displayQty)

watch(selected, value => {
    Inertia.get('/historico-puntos', { items: value }, {
        preserveState: true,
        replace: true
    });
});
...
<div class="table">
	...
	<div class="mt-6">
		<div class="table-header">
			<div class="table-header--li">Fecha</div>
			<div class="table-header--li">Puntos</div>
			<div class="table-header--li">Entrada</div>
		</div>
		...
		<div class="table-body" v-if="props.list">
			<div
				...
				<div class="table-body--li">
					<div class="table-body--li-indicator">Fecha</div>
					<div>{{ li.created_at }}</div>
				</div>
				<div class="table-body--li">
				...
				<div class="table-body--li">
					<div class="table-body--li-indicator">Entrada</div>
    ...
    <div v-if="props.list.links && props.list.links.length > 3">
