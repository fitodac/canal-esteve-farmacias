...
import DynamicTeacher from '@/Components/Courses/DynamicTeacher.vue';
...
const addTeacher = () => {
    teacher.push({ name: '', profession: '', description: '', image: '', })
}
            ...
            <form @submit.prevent="submit" class="max-w-xl mx-auto mt-10">
                ...
                <div class="grid md:grid-cols-2 md:gap-x-5">
                    <div class="mt-7">
                            ...
                            <InputError class="mt-2" :message="form.errors.format_id" />
                        </div>
                ...
                <div class="grid">
                    ...
                    <DynamicTeacher :teacher="item" v-for="item, index in teacher" :key="index"/>

                    <PrimaryButton class="text-sm w-full sm:w-auto" type="button" @click="addTeacher">+</PrimaryButton>
                    <SecondaryButton v-if="teacher.length > 1" class="text-sm w-full sm:w-auto"
                        type="button" @click="removeTeacher">x</SecondaryButton>
                </div>
