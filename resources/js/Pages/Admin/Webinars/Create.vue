...
const submit = () => {
    ...
    form.post(route('admin.webinars.store'));
};

const speaker = reactive([{ name: '', profession: '', description: '', image: '' }])
...
let schedule = reactive([{ title: '', description: '', from: '', to: '' }]);
            ...
            <form @submit.prevent="submit" class="max-w-xl mx-auto mt-10">
                ...
                <div class="grid md:grid-cols-2 md:gap-x-5">
                    <div class="mt-7">
                        ...
                        <VueDatePicker id="appointment_day" locale="es" class="mt-1 block w-full" v-model="form.appointment_day" placeholder="Fecha"
                                text-input
                    ...
                    <div class="mt-7">
                        ...
                        <VueDatePicker id="appointment_hour" class="mt-1 block w-full" v-model="form.appointment_hour" placeholder="Hora" time-picker
                        model-type="HH:mm"
                        cancelText="Cancelar" selectText="Aceptar"
                        format="HH:mm"/>
                ...
                <div class="grid mt-5">
                    ...
                    <SecondaryButton v-if="schedule.length > 1" class="text-sm w-full sm:w-auto"
                ...
                <div class="mt-10">
                    ...
                    <Link class="inline-flex items-center px-4 py-2 ml-4 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150" :class="{ 'opacity-25': form.processing }"
                        :disabled="form.processing" :href="route('admin.webinars.index')">
